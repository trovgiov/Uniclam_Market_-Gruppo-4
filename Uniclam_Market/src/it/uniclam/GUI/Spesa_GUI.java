	...
	private void initialize() {
		...
		btnAggiungiAlCarrello.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String response = Server.INSERT_PRODUCTS+"/"+barcode+"/"+idspesa+"/"+quantita;
				
				Login_GUI.out.println(response);
				
				String line = Login_GUI.in.readLine();
				if(line.contentEquals("prodotto inserito")){
					
					try {
						DefaultTableModel 	dm = new JTableOperation().getData(idspesa);
						table.setModel(dm);
					...
					JOptionPane.showMessageDialog(Spesa_GUI.this, "prodotto non inserito");
		...
		scrollPane.setBounds(46, 147, 691, 331);
